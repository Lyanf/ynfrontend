  ...
  <el-form label-position="right" label-width="auto">
    ...
    <div v-for="param in requiredParams" :key="param.key">
      <el-form-item :label="param.label + '：'">
        ...
        <el-checkbox-group
          v-else-if="param.kind.startsWith('multioption') && param.key === 'singleresult'"
          v-model="postParams.singleresult">
          <el-checkbox v-for="choice in param.value" :key="choice" :label="choice"></el-checkbox>
        </el-checkbox-group>
